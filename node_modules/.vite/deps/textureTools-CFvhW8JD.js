...
import { i as serialize, s as serializeAsColor4, v as __decorate } from "./decorators-_FK4m6kx.js";
import { n as SerializationHelper } from "./math.size-CdEu25xW.js";
import { i as IsDocumentAvailable, o as IsWindowObjectExist, t as PrecisionDate } from "./precisionDate-hRvRcdgy.js";
import { A as _RetryWithInterval, B as allocateAndCopyTypedBuffer, a as NearestPOT, c as InternalTexture, h as Effect, n as GetExponentOfTwo, o as AbstractEngine, r as IsExponentOfTwo, t as FloorPOT } from "./tools.functions-CE33bNKI.js";
import { a as PostProcessManager, o as SmartArray, r as RenderingManager } from "./math.frustum-BkR3BO98.js";
...
import { n as EffectWrapper } from "./effectRenderer-DgGG1Evk.js";
import { o as BaseTexture, t as Texture } from "./texture-CsLj3gtD.js";
import { i as HasStencilAspect, o as WebGLHardwareTexture, s as WebGLDataBuffer, t as ThinEngine } from "./thinEngine-QgDcmNn8.js";
	...
	*/
	isReadyForRendering() {
		if (!this._dumpToolsLoading) {
			...
			import("./dumpTools-BZUt0PiA.js").then((n) => n.a).then((module) => this._dumpTools = module);
		}
...
var PostProcess = class PostProcess {
	...
	*/
	...
	_gatherImports(useWebGPU = false, list) {
		if (useWebGPU && this._webGPUReady) list.push(Promise.all([import("./postprocess.vertex-B8lV1BJa.js").then((n) => n.n)]));
		else list.push(Promise.all([import("./postprocess.vertex-yM6bMHp9.js").then((n) => n.n)]));
	}
	/**
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
	const callbackAsync = async (loadData) => {
		...
		if (!width) return;
		const { DDSTools } = await import("./dds-C_wni7Rk.js");
		const textures = [];
...
function _GetCompatibleTextureLoader(extension, mimeType) {
	...
	if (!RegisteredTextureLoaders.has(extension)) {
		if (extension.endsWith(".ies")) registerTextureLoader(".ies", async () => await import("./iesTextureLoader-DBwm_UEA.js").then((n) => n.n).then((module) => new module._IESTextureLoader()));
		if (extension.endsWith(".dds")) registerTextureLoader(".dds", async () => await import("./ddsTextureLoader-Btg_KqSA.js").then((module) => new module._DDSTextureLoader()));
		if (extension.endsWith(".basis")) registerTextureLoader(".basis", async () => await import("./basisTextureLoader-BWaUsw1e.js").then((module) => new module._BasisTextureLoader()));
		if (extension.endsWith(".env")) registerTextureLoader(".env", async () => await import("./envTextureLoader-a4Uw_g3S.js").then((module) => new module._ENVTextureLoader()));
		if (extension.endsWith(".hdr")) registerTextureLoader(".hdr", async () => await import("./hdrTextureLoader-oZ-K-w-G.js").then((module) => new module._HDRTextureLoader()));
		if (extension.endsWith(".ktx") || extension.endsWith(".ktx2")) {
			registerTextureLoader(".ktx", async () => await import("./ktxTextureLoader-BJaf41xn.js").then((n) => n.n).then((module) => new module._KTXTextureLoader()));
			registerTextureLoader(".ktx2", async () => await import("./ktxTextureLoader-BJaf41xn.js").then((n) => n.n).then((module) => new module._KTXTextureLoader()));
		}
		if (extension.endsWith(".tga")) registerTextureLoader(".tga", async () => await import("./tgaTextureLoader-BDjElHOf.js").then((n) => n.n).then((module) => new module._TGATextureLoader()));
		if (extension.endsWith(".exr")) registerTextureLoader(".exr", async () => await import("./exrTextureLoader-COnNwqFI.js").then((n) => n.r).then((module) => new module._ExrTextureLoader()));
	}
...
var ThinPassPostProcess = class ThinPassPostProcess extends EffectWrapper {
	_gatherImports(useWebGPU, list) {
		if (useWebGPU) {
			...
			list.push(Promise.all([import("./pass.fragment-BC-Rv4DL.js").then((n) => n.n)]));
		} else list.push(Promise.all([import("./pass.fragment-B_EvuCy1.js").then((n) => n.n)]));
	...
	*/
	constructor(name, engine = null, options) {
		...
		if (!localOptions.engine) localOptions.engine = Engine.LastCreatedEngine;
		super(localOptions);
	}
};
/**
...
var ThinPassCubePostProcess = class ThinPassCubePostProcess extends EffectWrapper {
	_gatherImports(useWebGPU, list) {
		if (useWebGPU) {
			this._webGPUReady = true;
			list.push(Promise.all([import("./passCube.fragment-C0j3G-WK.js").then((n) => n.n)]));
		} else list.push(Promise.all([import("./passCube.fragment-BDLYwCjd.js").then((n) => n.n)]));
		super._gatherImports(useWebGPU, list);
	}
	/**
...
async function ReadPixelsUsingRTT(texture, width, height, face, lod) {
	const scene = texture.getScene();
	const engine = scene.getEngine();
	if (!engine.isWebGPU) if (texture.isCube) await import("./lodCube.fragment-BDdY6II1.js").then((n) => n.n);
	else await import("./lod.fragment-DCNYRe2j.js").then((n) => n.n);
	else if (texture.isCube) await import("./lodCube.fragment-CiHq4JvC.js").then((n) => n.n);
	else await import("./lod.fragment-qGxK1ZjG.js").then((n) => n.n);
	let lodPostProcess;
...
async function GetTextureDataAsync(texture, width, height, face = 0, lod = 0, forceRTT = false) {
	...
	if (forceRTT || IsCompressedTextureFormat(texture.textureFormat) || targetWidth !== textureWidth || targetHeight !== textureHeight) return await ReadPixelsUsingRTT(texture, targetWidth, targetHeight, face, lod);
...
//#endregion
export { PerformanceMonitor as A, registerTextureLoader as C, PositionNormalTextureVertex as D, SphericalPolynomial as E, Axis as F, Coordinate as I, Space as L, PostProcess as M, RenderTargetTexture as N, PositionNormalVertex as O, ObjectRenderer as P, _GetCompatibleTextureLoader as S, SphericalHarmonics as T, RequestFullscreen as _, TextureTools as a, _CommonDispose as b, PassCubePostProcess as c, ThinPassPostProcess as d, Engine as f, GetFontOffset as g, ExitPointerlock as h, GetTextureDataAsync as i, RollingAverage as j, RenderTargetWrapper as k, PassPostProcess as l, ExitFullscreen as m, CreateResizedCopy as n, ToHalfFloat as o, CreateImageBitmapFromSource as p, FromHalfFloat as r, WhenTextureReadyAsync as s, ApplyPostProcess as t, ThinPassCubePostProcess as u, RequestPointerlock as v, unregisterTextureLoader as w, _CommonInit as x, ResizeImageBitmap as y };

//# sourceMappingURL=textureTools-CFvhW8JD.js.map