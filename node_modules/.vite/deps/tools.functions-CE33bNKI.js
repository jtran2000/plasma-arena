...
import { a as IsNavigatorAvailable, i as IsDocumentAvailable, o as IsWindowObjectExist, r as GetDOMTextContent, t as PrecisionDate } from "./precisionDate-hRvRcdgy.js";
	...
	*/
	...
	_createTextureBase(url, noMipmap, invertY, scene, samplingMode = 3, onLoad = null, onError = null, prepareTexture, prepareTextureProcess, buffer = null, fallback = null, format = null, forcedExtension = null, mimeType, loaderOptions, useSRGBBuffer) {
		...
		if (loaderPromise) {
			...
			if (!buffer) this._loadFile(url, (data) => {
			...
			else if (buffer instanceof ArrayBuffer) callbackAsync(new Uint8Array(buffer));
			else if (ArrayBuffer.isView(buffer)) callbackAsync(buffer);
...
//# sourceMappingURL=tools.functions-CE33bNKI.js.map