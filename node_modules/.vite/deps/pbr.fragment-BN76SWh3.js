...
var name$22 = "samplerFragmentAlternateDeclaration";
var shader$22 = `#ifdef _DEFINENAME_
...
var name$21 = "pbrFragmentSamplersDeclaration";
var shader$21 = `#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
var name$20 = "pbrBlockAlbedoOpacity";
var shader$20 = `struct albedoOpacityOutParams
...
var name$19 = "pbrBlockReflectivity";
var shader$19 = `struct reflectivityOutParams
...
var name$18 = "pbrBlockAmbientOcclusion";
var shader$18 = `struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
var name$17 = "pbrBlockAlphaFresnel";
var shader$17 = `#ifdef ALPHAFRESNEL
...
var name$16 = "pbrBlockAnisotropic";
var shader$16 = `#ifdef ANISOTROPIC
...
var name$15 = "pbrBlockReflection";
var shader$15 = `#ifdef REFLECTION
...
var name$14 = "pbrBlockSheen";
var shader$14 = `#ifdef SHEEN
...
var name$13 = "pbrBlockClearcoat";
var shader$13 = `struct clearcoatOutParams
...
var name$12 = "pbrBlockIridescence";
var shader$12 = `struct iridescenceOutParams
...
var name$11 = "pbrBlockSubSurface";
var shader$11 = `struct subSurfaceOutParams
...
var name$10 = "pbrBlockReflectance0";
var shader$10 = `float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
...
var name$9 = "pbrClusteredLightingFunctions";
var shader$9 = `#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
var name$8 = "pbrBlockNormalFinal";
var shader$8 = `#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
var name$7 = "pbrBlockLightmapInit";
var shader$7 = `#ifdef LIGHTMAP
...
var name$6 = "pbrBlockGeometryInfo";
var shader$6 = `float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
var name$5 = "pbrBlockReflectance";
var shader$5 = `#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
var name$4 = "pbrBlockDirectLighting";
var shader$4 = `vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
var name$3 = "pbrBlockFinalLitComponents";
var shader$3 = `aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
var name$2 = "pbrBlockFinalUnlitComponents";
var shader$2 = `vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
var name$1 = "pbrBlockFinalColorComposition";
var shader$1 = `vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
//# sourceMappingURL=pbr.fragment-BN76SWh3.js.map