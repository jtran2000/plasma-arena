...
var name$11 = "pbrFragmentExtraDeclaration";
var shader$11 = `varying vPositionW: vec3f;
#if DEBUGMODE>0
...
var name$10 = "subSurfaceScatteringFunctions";
var shader$10 = `fn testLightingForSSS(diffusionProfile: f32)->bool
...
var name$9 = "pbrHelperFunctions";
var shader$9 = `#define MINIMUMVARIANCE 0.0005
...
var shader$8 = `struct preLightingInfo
{lightOffset: vec3f,
...
var name$7 = "pbrDirectLightingFalloffFunctions";
var shader$7 = `fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
var name$6 = "pbrBlockReflectance0";
var shader$6 = `var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
var name$5 = "pbrDirectLightingFunctions";
var shader$5 = `#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
...
var name$4 = "pbrIBLFunctions";
var shader$4 = `#if defined(REFLECTION) || defined(SS_REFRACTION)
...
var name$3 = "pbrBlockNormalGeometric";
var shader$3 = `var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
var name$2 = "pbrBlockImageProcessing";
var shader$2 = `#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
//# sourceMappingURL=pbrDebug-CxreN6ie.js.map