...
var _VolumeWebAudioSubNode = class extends _VolumeAudioSubNode {
	...
	constructor(engine) {
		super(engine);
		this._volume = new _WebAudioParameterComponent(engine, (this.node = new GainNode(engine._audioContext)).gain);
	}
	/** @internal */
	dispose() {
		super.dispose();
...
//# sourceMappingURL=webAudioBaseSubGraph-CtZ5zIiY.js.map