...
import { F as EncodeArrayBufferToBase64, n as Tools } from "./tools-D4fIBQfa.js";
import { r as nativeOverride, v as __decorate } from "./decorators-_FK4m6kx.js";
import { n as EffectWrapper, t as EffectRenderer } from "./effectRenderer-DgGG1Evk.js";
...
async function _CreateDumpResourcesAsync() {
	...
	const { ThinEngine: thinEngineClass } = await import("./thinEngine-QgDcmNn8.js").then((n) => n.n);
	...
	const { passPixelShader } = await import("./pass.fragment-B_EvuCy1.js").then((n) => n.n);
	return {
		canvas,
		dumpEngine: {
			engine,
...
//# sourceMappingURL=dumpTools-BZUt0PiA.js.map