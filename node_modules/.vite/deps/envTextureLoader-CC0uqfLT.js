...
import { t as Scene } from "./scene-CGTqlHHT.js";
import { a as Vector3 } from "./math.vector-ivCpDlc6.js";
import { t as Logger } from "./logger-CE6knO9r.js";
import { D as GetBlobBufferSource, n as Tools } from "./tools-D4fIBQfa.js";
import { c as InternalTexture } from "./tools.functions-CE33bNKI.js";
import { E as SphericalPolynomial, M as PostProcess, t as ApplyPostProcess } from "./textureTools-CFvhW8JD.js";
import { o as BaseTexture } from "./texture-CsLj3gtD.js";
import { n as DumpDataAsync } from "./dumpTools-BZUt0PiA.js";
import { t as CubeMapToSphericalPolynomialTools } from "./cubemapToSphericalPolynomial-DttCHRWQ.js";
...
var RGBDTextureTools = class {
	...
	*/
	static ExpandRGBDTexture(texture) {
		...
		const expandRgbdTextureAsync = async () => {
			...
			internalTexture.isReady = false;
			if (isWebGpu) await import("./rgbdDecode.fragment-B4HjIRsG.js").then((n) => n.n);
			else await import("./rgbdDecode.fragment-D9W6-MbZ.js").then((n) => n.n);
	...
	*/
	static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
		if (!scene.getEngine().isWebGPU) await import("./rgbdEncode.fragment-DSGkXJXu.js").then((n) => n.n);
		else await import("./rgbdEncode.fragment-CQLVxrEH.js").then((n) => n.n);
...
async function _UploadLevelsAsync(texture, imageData, canGenerateNonLODTextures, imageType = DefaultEnvironmentTextureImageType) {
	...
	if (expandTexture) {
		if (engine.isWebGPU) {
			shaderLanguage = 1;
			await import("./rgbdDecode.fragment-B4HjIRsG.js").then((n) => n.n);
		} else await import("./rgbdDecode.fragment-D9W6-MbZ.js").then((n) => n.n);
...
//#endregion
export { EnvironmentTextureTools as a, UploadEnvSpherical as c, _UpdateRGBDAsync as d, normalizeEnvInfo as f, CreateRadianceImageDataArrayBufferViews as i, UploadIrradianceLevelsAsync as l, CreateEnvTextureAsync as n, GetEnvInfo as o, RGBDTextureTools as p, CreateIrradianceImageDataArrayBufferViews as r, UploadEnvLevelsAsync as s, _ENVTextureLoader as t, UploadRadianceLevelsAsync as u };

//# sourceMappingURL=envTextureLoader-CC0uqfLT.js.map