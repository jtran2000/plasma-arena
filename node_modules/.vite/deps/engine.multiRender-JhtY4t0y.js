import { c as ILog2 } from "./math.scalar.functions-DMYdgtAr.js";
...
import { H as ErrorCodes, U as RuntimeError, k as GetTypeByteLength, n as Tools } from "./tools-D4fIBQfa.js";
import { g as serializeAsVector3, i as serialize, p as serializeAsQuaternion, r as nativeOverride, v as __decorate } from "./decorators-_FK4m6kx.js";
import { t as _WarnImport } from "./devTools-CGiGDI7K.js";
import { n as SerializationHelper } from "./math.size-CdEu25xW.js";
import { t as Node } from "./node-DOQ7By2v.js";
import { B as allocateAndCopyTypedBuffer, M as Initialize, P as Process, c as InternalTexture, d as AlphaState, g as resetCachedPipeline, h as Effect, j as Finalize, m as DepthCullingState, o as AbstractEngine, p as StencilStateComposer } from "./tools.functions-CE33bNKI.js";
import { t as ShaderStore } from "./shaderStore-CoW3hXTv.js";
import { t as UniformBuffer } from "./uniformBuffer-BFz9vKOT.js";
import { t as DataBuffer } from "./dataBuffer-BC17yCmb.js";
import { n as VertexBuffer, t as Buffer } from "./buffer-CbxLnFQ-.js";
import { t as PickingInfo } from "./pickingInfo-3l1eY6hl.js";
import { t as PerfCounter } from "./perfCounter-DbdHR8Q9.js";
import { n as extractMinAndMax, r as extractMinAndMaxIndexed } from "./math.functions-CACOD85M.js";
import { i as DrawWrapper } from "./effectRenderer-DgGG1Evk.js";
import { A as PerformanceMonitor, E as SphericalPolynomial, F as Axis, _ as RequestFullscreen, b as _CommonDispose, g as GetFontOffset, h as ExitPointerlock, k as RenderTargetWrapper, m as ExitFullscreen, p as CreateImageBitmapFromSource, r as FromHalfFloat, v as RequestPointerlock, x as _CommonInit, y as ResizeImageBitmap } from "./textureTools-CFvhW8JD.js";
import { i as HasStencilAspect, r as GetTypeForDepthTexture, u as IsWrapper } from "./thinEngine-QgDcmNn8.js";
import { n as _SpatialAudioAttacherComponent, t as _SpatialWebAudioUpdaterComponent } from "./spatialWebAudioUpdaterComponent-BBRWG9W9.js";
import { i as _WebAudioParameterComponent, t as AbstractAudioNode } from "./abstractAudioNode-iPMGG31J.js";
import { t as WebGPUPerfCounter } from "./webgpuPerfCounter-mjaxRp1o.js";
...
var AbstractMesh = class AbstractMesh extends TransformNode {
	...
	*/
	async optimizeIndicesAsync() {
		...
		const { OptimizeIndices } = await import("./mesh.vertexData.functions-B8fzSv5v.js").then((n) => n.n);
...
var _WebAudioEngine = class extends AudioEngineV2 {
	...
	*/
	...
	async createBusAsync(name, options = {}) {
		const bus = new (await (import("./webAudioBus-Dza6b44Z.js")))._WebAudioBus(name, this, options);
		await bus._initAsync(options);
		return bus;
	}
	/** @internal */
	async createMainBusAsync(name, options = {}) {
		const bus = new (await (import("./webAudioMainBus-Du3xAMWC.js").then((n) => n.n)))._WebAudioMainBus(name, this);
		await bus._initAsync(options);
		return bus;
	}
	/** @internal */
	...
	async createSoundAsync(name, source, options = {}) {
		const sound = new (await (import("./webAudioStaticSound-K77Exk_O.js")))._WebAudioStaticSound(name, this, options);
		await sound._initAsync(source, options);
		return sound;
	}
	/** @internal */
	async createSoundBufferAsync(source, options = {}) {
		const soundBuffer = new (await (import("./webAudioStaticSound-K77Exk_O.js")))._WebAudioStaticSoundBuffer(this);
		await soundBuffer._initAsync(source, options);
		return soundBuffer;
	}
	/** @internal */
	async createSoundSourceAsync(name, source, options = {}) {
		const soundSource = new (await (import("./webAudioSoundSource-DNWvcyN1.js")))._WebAudioSoundSource(name, source, this, options);
		await soundSource._initAsync(options);
		return soundSource;
	}
	/** @internal */
	async createStreamingSoundAsync(name, source, options = {}) {
		const sound = new (await (import("./webAudioStreamingSound-BSisOGOw.js")))._WebAudioStreamingSound(name, this, options);
		await sound._initAsync(source, options);
		return sound;
	}
	/** @internal */
	...
	*/
	...
	_collectFunctions() {
		...
		while (startIndex < this._sourceCode.length) {
			...
			this._sourceCode = (inlineTokenIndex > 0 ? this._sourceCode.substring(0, inlineTokenIndex) : "") + (funcBodyEndIndex + 1 < this._sourceCode.length - 1 ? this._sourceCode.substring(funcBodyEndIndex + 1) : "");
	...
	*/
	initAsync(glslangOptions, twgslOptions) {
		...
		return navigator.gpu.requestAdapter(this._options).then(async (adapter) => {
			if (!adapter) throw "Could not retrieve a WebGPU adapter (adapter is null).";
			else {
	...
	_initializeLimits() {
		...
		this._caps = {
			...
			dualSourceBlending: this._deviceEnabledExtensions.indexOf("dual-source-blending") !== -1
		};
		this._features = {
...
//#endregion
export { VertexStepMode as $, FilterMode as A, inlineScheduler as At, RenderPassTimestampLocation as B, CompareFunction as C, VertexDataMaterialInfo as Ct, DeviceLostReason as D, BoundingBox as Dt, CullMode as E, BoundingSphere as Et, MipmapFilterMode as F, runCoroutineSync as Ft, StoreOp as G, ShaderStage as H, PipelineErrorReason as I, TransformNode as It, TextureFormat as J, TextureAspect as K, PowerPreference as L, IndexFormat as M, makeSyncFunction as Mt, LoadOp as N, runCoroutine as Nt, ErrorFilter as O, IntersectionInfo as Ot, MapMode as P, runCoroutineAsync as Pt, VertexFormat as Q, PrimitiveTopology as R, ColorWrite as S, VertexData as St, ComputePassTimestampLocation as T, BoundingInfo as Tt, StencilOperation as U, SamplerBindingType as V, StorageTextureAccess as W, TextureUsage as X, TextureSampleType as Y, TextureViewDimension as Z, BufferBindingType as _, CreateStreamingSoundAsync as _t, WebGPUDrawContext as a, CreateAudioEngineAsync as at, CanvasAlphaMode as b, AbstractMesh as bt, WebGPUCacheRenderPipeline as c, _HasSpatialAudioListenerOptions as ct, WebGPUPipelineContext as d, CreateAudioBusAsync as dt, _OcclusionDataStorage as et, WebGPUShaderProcessor as f, CreateMainAudioBusAsync as ft, BlendOperation as g, CreateSoundSourceAsync as gt, BlendFactor as h, CreateSoundBufferAsync as ht, WebGPUCacheBindGroups as i, AudioEngine as it, FrontFace as j, makeAsyncFunction as jt, FeatureName as k, createYieldingScheduler as kt, WebGPUCacheSampler as l, _SpatialAudioListenerDefaults as lt, AutoLayoutMode as m, CreateSoundAsync as mt, WebGPURenderTargetWrapper as n, ShaderCodeInliner as nt, ExternalTexture as o, _WebAudioEngine as ot, AddressMode as p, CreateMicrophoneSoundSourceAsync as pt, TextureDimension as q, WebGPUTintWASM as r, InjectStartingAndEndingCode as rt, WebGPUCacheRenderPipelineTree as s, AbstractSpatialAudioListener as st, WebGPUEngine as t, checkNonFloatVertexBuffers as tt, WebGPUDataBuffer as u, AudioEngineV2 as ut, BufferMapState as v, LastCreatedAudioEngine as vt, CompilationMessageType as w, SubMesh as wt, CanvasToneMappingMode as x, _MeshCollisionData as xt, BufferUsage as y, _GetAudioEngine as yt, QueryType as z };

//# sourceMappingURL=engine.multiRender-JhtY4t0y.js.map