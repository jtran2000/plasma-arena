...
export const g = {
  ...
  rifleBarrelBasePosition: Vector3.Zero(),
  rifleBrakeBasePosition: Vector3.Zero(),
  rifleLaserSightBasePosition: Vector3.Zero(),
  rifleBayonetBasePosition: Vector3.Zero(),
  rifleBarrelBaseScaling: Vector3.One(),
  rifleBrakeBaseScaling: Vector3.One(),
  rifleLaserSightBaseScaling: Vector3.One(),
  rifleBayonetBaseScaling: Vector3.One(),
